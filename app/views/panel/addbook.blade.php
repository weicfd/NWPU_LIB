        ...
        <div class="module-body">
            <form class="form-horizontal row-fluid">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" data-form-field="isbn" placeholder="Click here then scan the ISBN number" class="span8">
                    </div>
                </div>

                <div class="control-group">
                    <label class="control-label" for="basicinput">Location of Book</label>
                    <div class="controls">
                        <textarea class="span8" data-form-field="description" rows="5" placeholder="Enter the location for the book here"></textarea>
                    </div>
                </div>
