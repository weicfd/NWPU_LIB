            ...
            if($.isEmptyObject(data)){
                ...
                for(var books in data) {
                    ...
                    if(book.avaliability){
                        book.avaliability = '<a class="btn btn-success" style="cursor: default">Available</a>';
                    } else {
                        book.avaliability = '<a class="btn btn-danger" style="cursor: default">Not Available</a>';
                    }
...
$(document).ready(function(){   
    ...
    $(".form-submit").submit(function() {
        ...
        switch(mode){
            ...
            case 'issue' :
                var searched_book = $(this).find('input').val(),
                    module_box = $(this).parents('.module').find('#module-body-results');
            ...
            case 'student' :
                var searched_student = $(this).find('input').val(),
                    module_box = $(this).parents('.module').find('#module-body-results');
